...
3. 00Kamishiro/UDONEventCalendar/Prefabs 内のお好みのプレハブをシーン内に設置してください。  

### 各プレハブの相違
* UdonEventCalendar_Unlit - 光源の影響を受けないカレンダーです。  
* UdonEventCalendar_Lit - 光源の影響を受けるカレンダーです。  

### Lit系の輝度調節
* プレハブの "UDON Event Calendar" コンポーネントの 輝度スライダーを調整してください。  
