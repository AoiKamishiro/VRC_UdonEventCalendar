...
{
    public class SyncScrollCalendar : UdonSharpBehaviour
    {
        ...
        [UdonSynced(UdonSyncMode.None)] private float scrollValueSynced = 0f;
        ...
        {
            scrollValueSynced = scrollValue;
        }
        public override void OnDeserialization()
        {
            scrollValue = scrollValueSynced;
            SetSliderValue();
        ...
        {
            if (!Networking.IsOwner(lp, gameObject))
            {
